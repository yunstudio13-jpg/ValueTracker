      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-white dark:bg-gray-900 border-none rounded-2xl pl-12 pr-4 py-4 shadow-sm focus:ring-2 focus:ring-black dark:focus:ring-white transition-all"
          />
        </div>
